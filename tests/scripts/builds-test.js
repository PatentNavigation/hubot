...
describe('builds command', function() {
  ...
  let apps = [
    ...
    },
    {
      id: 'squirrel-app',
      appName: "SomeApp",
      circleUrl: "PatentNavigation/squirrel-app",
      stage: {
        squirrel: 'squirrel'
      },
      prod: {
  ...
  describe('deployed in *', function() {
    it('works', function() {
      ...
      sandbox.stub(squirrel, 'fetchBuildVersion', () => resolve("333"));
                ...
                fields: [
                  ...
                  },
                  {
                    ...
                    value: [
                      ...
                      '<https://circleci.com/gh/PatentNavigation/squirrel-app/333|Circle Build 333>'
                    ].join('\n'),
                    short: true
                  },
                  {
    ...
    it('handles errors', function() {
      ...
      sandbox.stub(opsworks, 'fetchBuildVersion', () => resolve("333"));
      sandbox.stub(squirrel, 'fetchBuildVersion', () => reject(new Error("Something went wrong!")));
  ...
  describe('builds for', function() {
    describe('all', function() {
      it('works', function() {
        ...
        stub.withArgs(getApp('squirrel-app')).returns(resolve({ buildNum: '555', revision: 'abcdef123456789' }));
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      value: [
                        ...
                        '<https://circleci.com/gh/PatentNavigation/squirrel-app/555|Circle Build 555>'
                      ].join('\n'),
                      short: true
                    }
                  ]
